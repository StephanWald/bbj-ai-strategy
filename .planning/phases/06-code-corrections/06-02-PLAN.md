...
must_haves:
  truths:
    - "Chapter 5 response examples show correct Visual PRO/5 mnemonic syntax, not WINDOW CREATE verbs"
    - "Generation tagging tables in Chapters 3 and 6 list correct Visual PRO/5 examples"
    - "Chapter 4 detection code and descriptions reference correct Visual PRO/5 patterns"
    - "Chapter 6 JSON metadata examples use correct Visual PRO/5 syntax"
    - "Chapter 2 narrative description of Visual PRO/5 matches corrected patterns"
    - "Chapter 3 OrderForm class code block is verified correct (no changes needed)"
    - "Chapter 5 modern BBj code block is verified correct (no changes needed)"
  artifacts:
