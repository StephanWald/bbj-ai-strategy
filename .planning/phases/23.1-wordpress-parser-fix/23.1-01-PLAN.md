...
Output: A working WordPress parser that handles both extension-based and Content-Type-based PDF detection, with comprehensive tests.
</objective>
...
<success_criteria>
WordPress parser handles PDFs via both URL extension and Content-Type header detection. All tests pass including new Content-Type tests. `make check` is green.
</success_criteria>
