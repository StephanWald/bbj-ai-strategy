...
- [ ] **SCAF-01**: Docusaurus 3.9.2 project initialized with Rspack (`@docusaurus/faster`) for fast builds
- [ ] **SCAF-02**: 7-chapter folder structure with numbered prefixes and autogenerated sidebar
- [ ] **SCAF-03**: GitHub Actions workflow deploys site to GitHub Pages on push to main
- [ ] **SCAF-04**: `baseUrl` and `trailingSlash` configured correctly for GitHub Pages
