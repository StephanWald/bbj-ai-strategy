...
**Status:** Training data structure defined (9,922 ChatML examples in bbjllm); Qwen2.5-Coder-14B-Base recommended as next model. See [Fine-Tuning](/docs/fine-tuning).
:::
...
- **Active research:** Copilot BYOK integration remains in early exploration; [Continue.dev](https://www.continue.dev/) is being evaluated as the primary IDE integration path.
